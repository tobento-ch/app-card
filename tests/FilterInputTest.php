...
use Tobento\App\Card\FilterInput;
use Tobento\App\Card\FilterInputInterface;

class FilterInputTest extends TestCase
{
    public function testThatImplementsFilterInputInterfaces()
    {
        $this->assertInstanceof(FilterInputInterface::class, new FilterInput([]));
    }
    
    public function testHasMethod()
    {
        $input = new FilterInput(['foo' => 'Foo', 'options' => ['color' => 'blue'], 5 => '5']);
    ...
    {
        $input = new FilterInput(['foo' => 'Foo', 'options' => ['color' => 'blue']]);
